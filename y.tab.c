...
{
  "\"end of file\"", "error", "\"invalid token\"", "END", "TYPE", "SET",
  "ARRAY", "SIZEOF", "BEG", "ENDL", "INTEGER", "VARIABLE", "BOOL", "DO",
  "WHILE", "IF", "THEN", "ELSE", "PRINT", "FUNCTION", "IFX", "GE", "LE",
  "EQ", "NE", "G", "L", "PLUS", "MINUS", "AND", "OR", "UMINUS", "';'",
...
#line 58 "grammar.y"
                              { (yyval.nPtr) = opr(SET, 2, id((yyvsp[-3].sIndex)), (yyvsp[-1].nPtr)); }
#line 1294 "y.tab.c"
    break;
...
#line 61 "grammar.y"
                                       { (yyval.nPtr) = opr(IF, 2, (yyvsp[-3].nPtr), (yyvsp[0].nPtr)); }
#line 1312 "y.tab.c"
    break;
...
#line 65 "grammar.y"
                         { (yyval.nPtr) = opr(FUNCTION, 1, id((yyvsp[-1].sIndex)));}
#line 1336 "y.tab.c"
    break;
